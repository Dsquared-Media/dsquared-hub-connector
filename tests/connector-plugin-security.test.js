...
// ---------------------------------------------------------------------------
// Package readiness: DHC_VERSION is 1.17.4
// ---------------------------------------------------------------------------

test('plugin: DHC_VERSION constant is 1.17.4', () => {
    assert.ok(
        pluginMain.includes("define( 'DHC_VERSION', '1.17.4' )"),
        "DHC_VERSION must be '1.17.4'"
    );
});

test('plugin: file header Version comment is 1.17.4', () => {
    assert.ok(
        pluginMain.includes('* Version:           1.17.4'),
        'Plugin file header comment must declare Version: 1.17.4'
    );
});
